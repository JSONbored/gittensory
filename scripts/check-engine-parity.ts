...
// the normalized bodies diverge. Also compares the workspace-installed @jsonbored/loopover-engine semver against
...
const ENGINE_PACKAGE_NAME = "@jsonbored/loopover-engine";
...
/**
 * Version-skew tripwire: installed @jsonbored/loopover-engine must be >= the monorepo engine package version.
