// Test/code-path classifiers, extracted to `@jsonbored/loopover-engine` so the published
...
// packages/gittensory-engine/src/signals/test-evidence.ts (imported via relative source path, not
