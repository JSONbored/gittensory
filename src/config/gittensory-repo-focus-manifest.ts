...
# Authoritative gate blocker policy, config-as-code (layered OVER dashboard repository settings:
# .gittensory.yml > DB settings > safe defaults). This only selects which deterministic blockers are
# active — ONLY confirmed Gittensor contributors are ever hard-blocked (see PR #644). Turning the gate
# itself on/off remains a repository setting (gateCheckMode).
gate:
