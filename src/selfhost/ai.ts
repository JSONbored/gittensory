  ...
  return {
    async run(model, options) {
      ...
      if (Array.isArray(options.text)) {
        ...
        // Keep the thrown value status-only like the chat providers below: embedding error bodies are
        // provider-controlled and may echo private input, and RAG fail-safe logs this error for operators.
