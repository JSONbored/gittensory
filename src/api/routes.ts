...
// Batch A+B (loopover#6442/#6443): these fields moved off the DB entirely -- rawSettings (getRepositorySettings)
...
// behavior. Overlays the true EFFECTIVE value for just these fields onto an otherwise-raw-DB settings
