...
REES_FORWARD_GITHUB_TOKEN=true`}
      ...
      <p>
        ...
        analyzer names. Unknown names are ignored with a{" "}
        <code>rees_analyzer_config_invalid</code> warning and the remaining valid analyzers still
        run. If every configured name is invalid, the engine sends an empty analyzer list so the
        typo fails closed instead of running the full registry.
      </p>
      <CodeBlock
        filename=".env"
