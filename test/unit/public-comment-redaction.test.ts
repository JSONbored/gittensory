...
// suite drives the moved module directly (proving portability + covering the engine source) and asserts the
// redaction behavior is byte-for-byte what the command layer relied on.
import { sanitizePublicComment } from "../../packages/gittensory-engine/src/public-comment-redaction";
