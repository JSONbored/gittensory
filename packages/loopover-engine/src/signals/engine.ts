...
// Canonical implementation lives in issue-quality.ts so @loopover/engine's package build can export it (#6057).
export { buildIssueQualityReport } from "./issue-quality.js";
