...
import { resolveUpgradeCommand, startUpdateCheck } from "../lib/update-check.js";
...
const updateCheck = startUpdateCheck(cliArgs, { packageName, packageVersion, upgradeCommand });
