...
// Every local SQLite store documented in DEPLOYMENT.md's laptop-mode file listing -- backup/restore must cover
// ALL of them, not just the subset doctor/migrate happen to track, or an operator following the backup/restore
// guidance would silently lose data in the stores left out (#4872 gate review).
const STORES = [
  ...
  { name: "governor-state", resolveDbPath: resolveGovernorStateDbPath },
  { name: "attempt-log", resolveDbPath: resolveAttemptLogDbPath },
  { name: "worktree-allocator", resolveDbPath: resolveWorktreeAllocatorDbPath },
  { name: "prediction-ledger", resolveDbPath: resolvePredictionLedgerDbPath },
  { name: "replay-snapshot", resolveDbPath: resolveReplaySnapshotDbPath },
  { name: "policy-doc-cache", resolveDbPath: resolvePolicyDocCacheDbPath },
  { name: "policy-verdict-cache", resolveDbPath: resolvePolicyVerdictCacheDbPath },
  { name: "deny-hook-synthesis", resolveDbPath: resolveDenyHookSynthesisDbPath },
  { name: "orb-export", resolveDbPath: resolveOrbExportDbPath },
];
