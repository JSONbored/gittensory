...
// @jsonbored/loopover-engine (same gap #5145's own header documents for `issueQuality`). This is not a
...
// @jsonbored/loopover-engine's public barrel) -- "none" when the issue isn't part of any cluster at all.
 ...
 * @returns {import("@jsonbored/loopover-engine").FeasibilityGateResult}
 */
 ...
 * @param {import("@jsonbored/loopover-engine").FeasibilityGateResult} feasibility
 * @returns {import("@jsonbored/loopover-engine").AcceptanceCriteria}
 */
 ...
 * @param {import("@jsonbored/loopover-engine").AcceptanceCriteria} acceptanceCriteria
