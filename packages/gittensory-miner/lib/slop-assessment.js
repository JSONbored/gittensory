import { buildSlopAssessment } from "@jsonbored/loopover-engine";
...
/**
 * @param {import("@jsonbored/loopover-engine").SlopAssessmentInput} input
 * @returns {import("@jsonbored/loopover-engine").SlopAssessment}
 */
