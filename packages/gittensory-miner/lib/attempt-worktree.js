...
import { addWorktree, removeWorktree, shouldRetainWorktree } from "@jsonbored/loopover-engine";
...
// the missing base-clone-management step) with @jsonbored/loopover-engine's already-built, already-tested
 ...
 * rejection.
 *
 * @returns {import("@jsonbored/loopover-engine").WorktreeExecFn}
 */
 ...
 *   exec?: import("@jsonbored/loopover-engine").WorktreeExecFn, timeoutMs?: number,
 ...
 * @param {{ exec?: import("@jsonbored/loopover-engine").WorktreeExecFn, timeoutMs?: number }} [options]
