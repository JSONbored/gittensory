 ...
 * @returns {{ scope: import("@jsonbored/loopover-engine").MinerKillSwitchScope, active: boolean }}
 */
 ...
 * @param {import("@jsonbored/loopover-engine").MinerKillSwitchScope} input.previousScope
 * @param {import("@jsonbored/loopover-engine").MinerKillSwitchScope} input.scope
