...
// maintainer-side duplicate-cluster election (`isDuplicateClusterWinnerByClaim` from @jsonbored/loopover-engine)
...
import { isDuplicateClusterWinnerByClaim, resolveDuplicateClusterWinnerNumber } from "@jsonbored/loopover-engine";
