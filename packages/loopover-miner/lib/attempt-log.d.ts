...
export declare function resolveAttemptLogDbPath(env?: Record<string, string | undefined>): string;
/**
 ...
 * order. (#4294)
 */
export declare function initAttemptLog(dbPath?: string): AttemptLog;
export declare function appendAttemptLogEvent(event: AttemptLogEvent): AttemptLogEntry;
export declare function readAttemptLogEvents(filter?: ReadAttemptLogEventsFilter): AttemptLogEntry[];
export declare function exportAttemptLogJsonl(attemptId: string): string;
export declare function closeDefaultAttemptLog(): void;
