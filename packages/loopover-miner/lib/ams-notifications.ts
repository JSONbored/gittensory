...
//
// Keep dedupKey / deeplink layout in lockstep with src/notifications/ams-events.ts (hosted twin — miner
// cannot import src/).
...
export function buildAmsPrOutcomePayload(input: {
  ...
  return {
    ...
    // Same layout as src/notifications/ams-events.ts buildAmsPrOutcomeEvent.
